package com.adrian.spring6restmvc.bootstrap;
...
import com.adrian.spring6restmvc.repositories.CustomerRepository;
import com.adrian.spring6restmvc.repositories.BeerRepository;
import com.adrian.spring6restmvc.services.BeerCsvService;
    ...
    private void loadCsvData() throws FileNotFoundException {
        if (beerRepository.count() < 10) {
            ...
            beerRecords.forEach(beerRecord -> {
                BeerStyle beerStyle = switch (beerRecord.getStyle()) {
                ...
                beerRepository.save(Beer.builder()
                                ...
                                .upc(beerRecord.getRow().toString())
                                .quantityOnHand(beerRecord.getCount())
                        .build());
            });
        }
    }
